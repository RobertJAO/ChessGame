...
class GameTurnWhite extends MovePieceTemplate implements GameState {

	private final ChessGame chessGame;
	private static final Color GAME_TURN_COLOR = Color.WHITE;
	
	public GameTurnWhite(ChessGame chessGame) {
		super();
	...
	@Override
	public void resign() {
		this.chessGame.setWinner(this.chessGame.getPlayerBlack());
	...
	protected void changeGameTurn() {
		//the game turn passes to black
		this.chessGame.setGameState(this.chessGame.getGameTurnBlack());
	}
